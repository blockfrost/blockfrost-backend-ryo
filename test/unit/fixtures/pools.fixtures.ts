...
const query_pools_extended_reuglar_1 = [
  {
    ...
    hex: '67420c9a7036aecc50e72109030659c2636ac6f81d36cbee0be2f8c2',
    active_stake: '1009512035649',
    live_stake: '9497432569',
    live_saturation: 0.00013344914490930282,
    blocks_minted: 0,
    declared_pledge: '1000000000',
    margin_cost: 0.1,
    fixed_cost: '340000000',
    metadata: {
      url: 'https://tinyurl.com/263p356z',
      hash: '276f035319f342a84f7e8abf8ec0befde2434bcb29f20f41afd09132fb083fd1',
      ticker: 'MIT01',
      name: 'Mithril Signer MIT01',
      description: 'Mithril Signer Node testing-preview.api.mithril.network',
      homepage: 'https://mithril.network',
    },
  },
  {
    pool_id: 'pool1n6tcrkjjn7dr70e4vjmtayswl2rne947fue7w2htthaq6men4yp',
    hex: '9e9781da529f9a3f3f3564b6be920efa873c96be4f33e72aeb5dfa0d',
    active_stake: '346491334058',
    live_stake: '346491334058',
    live_saturation: 0.004868575998049152,
    blocks_minted: 5675,
    declared_pledge: '14000000000',
    margin_cost: 0.01,
    fixed_cost: '340000000',
    metadata: {
      url: 'https://preview.blockchainbill.lol/SNSOB.metadata.json',
      hash: '4792d9a653baab097047724e97896697c4d1f04accd9e9d126f1786102f1e2d4',
      ticker: null,
      name: null,
      description: null,
      homepage: null,
  ...
  {
    pool_id: 'pool1yphncqvpc4n49c4ya3mys7uwpwa25892r70gzkpqglenv093qge',
    hex: '206f3c0181c56752e2a4ec76487b8e0bbaaa1caa1f9e81582047f336',
    active_stake: '13084660011970',
    live_stake: '11332280122647',
    live_saturation: 0.15923072696257765,
    blocks_minted: 40427,
    declared_pledge: '300000000000',
    margin_cost: 0.02,
    fixed_cost: '340000000',
    metadata: {
      url: 'https://cardano-blockhouse.de/preview/poolMetaData.json',
      hash: 'b570b17ca6e0b44783f4a18654f14b472460f0f553e2cc29eaa25a7a2f874f09',
      ticker: null,
      name: null,
      description: null,
      homepage: null,
