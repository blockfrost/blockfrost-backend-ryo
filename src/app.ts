...
const start = (options = {}): FastifyInstance => {
  ...
  registerRoute(app, import('./routes/accounts/stake-address/transactions.js'));
  ...
  registerRoute(app, import('./routes/blocks/hash-or-number/txs/index.js'));
  registerRoute(app, import('./routes/blocks/hash-or-number/txs/cbor.js'));
  ...
  registerRoute(app, import('./routes/scripts/script_hash/utxos.js'));
