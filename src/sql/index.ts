...
const QUERY_FILES = {
  ...
  accounts_stake_address_addresses_total_over_limit:
    'accounts/accounts_stake_address_addresses_total_over_limit.sql',
  ...
  addresses_address_total_over_limit: 'addresses/addresses_address_total_over_limit.sql',
  ...
  governance_committee: 'governance/committee.sql',
  governance_committee_votes: 'governance/committee_votes.sql',
